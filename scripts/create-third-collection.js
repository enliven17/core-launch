...
async function main() {
  console.log("🚀 Creating third sample NFT collection on Core Blockchain Testnet2...");
  ...
  const name = "Gaming Legends";
  const symbol = "GL";
  const baseURI = "https://api.example.com/gaming/"; // Placeholder URI
