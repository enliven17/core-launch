...
async function main() {
  console.log("🚀 Creating second sample NFT collection on Core Blockchain Testnet2...");
  ...
  const name = "Digital Art Masters";
  const symbol = "DAM";
  const baseURI = "https://api.example.com/dam/"; // Placeholder URI
  const maxSupply = 500; // Maximum 500 NFTs
