...
export default function CollectionForm({ onSubmit, isLoading = false }: CollectionFormProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {!isConnected ? (
        <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-3xl p-8 text-center shadow-lg backdrop-blur-sm">
          <div className="flex items-center justify-center space-x-3 text-yellow-300 mb-6">
          ...
          <p className="text-yellow-200 mb-6 text-lg leading-relaxed">
            Please connect your wallet to create a collection. Make sure you're connected to Core Blockchain Testnet2. Collection creation fee: 0.1 CORE.
          </p>
        ...
        <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/30 rounded-3xl p-8 text-center shadow-lg backdrop-blur-sm">
          <div className="flex items-center justify-center space-x-3 text-orange-300 mb-6">
          ...
          <p className="text-orange-200 mb-6 text-lg leading-relaxed">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="p-6 space-y-8">
          ...
          {/* Creation Fee Notice */}
          <div className="bg-gradient-to-r from-primary-500/10 to-secondary-500/10 border border-primary-500/30 rounded-2xl p-6 backdrop-blur-sm">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-white">Collection Creation Fee</h3>
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Fee Amount:</span>
                <span className="text-xl font-bold text-primary-400">0.1 CORE</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-blue-400 font-medium">Core Testnet2</span>
              </div>
            </div>
            <p className="text-sm text-primary-300 mt-3 text-center">
              This fee covers the gas costs for deploying your collection contract to the blockchain.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-white flex items-center space-x-2">
              <span className="w-5 h-5 bg-secondary-400 rounded-full flex items-center justify-center text-xs font-bold text-white">₵</span>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 text-center">
              ...
              <p className="text-green-300 text-sm">
                Your collection will be deployed for <span className="font-bold">0.1 CORE</span> on Core Testnet2
              </p>
            </div>
